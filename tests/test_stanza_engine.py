...
def test_stanza_integration_english():
    ...
    """
    text = "The scientist confirmed that the results, which were obtained after the experiment that the team conducted last year, significantly contradict the previous theories."
    params = {
        "engine": "stanza",
        "lang": "en",
    ...
    assert root.label == "ROOT" or root.label == "S"
